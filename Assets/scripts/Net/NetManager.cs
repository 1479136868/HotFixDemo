...
public class NetManager : Singleton<NetManager>
{
    ...
    public Action<int> luaConnectCallback;
    public Action<int, byte[]> luaReceiveCallback;

    public void AddLuaCallBack(Action<int> a, Action<int, byte[]> b)
    {
        this.luaConnectCallback = a;
        this.luaReceiveCallback = b;
    }
    /// <summary>
    /// 和服务器建立链接
    /// </summary>
    ...
    private void connectCallback(IAsyncResult ar)
    {
        ...
        try
        {
            ...
            luaConnectCallback?.Invoke(1);
        }
        catch (Exception ex)
        {
            Debug.Log("链接失败" + ex.Message);
            luaConnectCallback?.Invoke(0);
        }
    }
    ...
    public void sendMsgToServer(int id, byte[] pbData)
    {
    ...
    public void Update()
    {
        ...
        while (msgQueue.Count > 0)
        {
            ...
            luaReceiveCallback?.Invoke(msgID, pbData);
